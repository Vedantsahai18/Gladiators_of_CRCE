...
def precision_recall_fscore(cm, class_weights):
    ...
    return precision, recall, fscore, precision_total, recall_total, fscore_total
...
precision, recall, fscore, precision_total, recall_total, fscore_total = precision_recall_fscore(cm, cm_plot_labels)
